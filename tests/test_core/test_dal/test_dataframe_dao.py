...
# Modified   : Wednesday January 4th 2023 07:41:27 pm                                              #
# ------------------------------------------------------------------------------------------------ #
# License    : MIT License                                                                         #
...
class TestDataFrameDAO:  # pragma: no cover
    ...
    def test_update(self, container, datasets, caplog):
        ...
        with pytest.raises(mysql.connector.ProgrammingError):
            bogus_dataframe = datasets[0].dataframes["dataframe_3_dataset_1"]
            bogus_dataframe.id = 7890
            dao.update(bogus_dataframe)
