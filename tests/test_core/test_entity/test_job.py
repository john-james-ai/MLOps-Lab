...
class TestJob:  # pragma: no cover
    ...
    # ============================================================================================ #
    def test_instantiation_data(self, caplog):
        start = datetime.now()
        logger.info(
            "\n\n\tStarted {} {} at {} on {}".format(
                self.__class__.__name__,
    ...
    # ============================================================================================ #
    def test_instantiation_task(self, caplog):
        start = datetime.now()
        logger.info(
            "\n\n\tStarted {} {} at {} on {}".format(
                self.__class__.__name__,
    ...
    def test_add_task(self, caplog):
        ...
        df1 = Task(name="new_task", description="some new task", operator=MockOperator())
        ...
        df3 = Task(name="new_task", description="some new task", operator=MockOperator())
        d.add_task(df3)
        df3.parent = d
        assert df3.parent == d
    ...
    # ============================================================================================ #
    def test_update_tasks(self, jobs, tasks, caplog):
        start = datetime.now()
        logger.info(
            "\n\nStarted {} {} at {} on {}".format(
                self.__class__.__name__,
        ...
        for i, job in enumerate(jobs, start=1):
            for j in range(1, 6):
                taskname = f"task_{j}_job_{i}"
                task = job.get_task(taskname)
    ...
    # ============================================================================================ #
    def test_remove_task(self, jobs, caplog):
        start = datetime.now()
        logger.info(
            "\n\n\tStarted {} {} at {} on {}".format(
                self.__class__.__name__,
    ...
    # ============================================================================================ #
    def test_equality(self, tasks, jobs, caplog):
        start = datetime.now()
        logger.info(
            "\n\n\tStarted {} {} at {} on {}".format(
                self.__class__.__name__,
        ...
        for i, job in enumerate(jobs, start=1):
            ...
            for j in range(1, 6):
                taskname = f"task_{j}_job_{i}"
                new_task = job.get_task(taskname)
                assert new_task != tasks[0]
        # ---------------------------------------------------------------------------------------- #
        end = datetime.now()
        duration = round((end - start).total_seconds(), 1)
    ...
    # ============================================================================================ #
    def test_task_data(self, caplog):
        start = datetime.now()
        logger.info(
            "\n\n\tStarted {} {} at {} on {}".format(
                self.__class__.__name__,
        ...
        # ---------------------------------------------------------------------------------------- #
        df = Task(name="new_task", description="some new task", operator=MockOperator())
...
@pytest.mark.job
@pytest.mark.job_run
class TestJobRun:  # pragma: no cover
    # ============================================================================================ #
    def test_mockjob(self, container, mockjob, caplog):
        start = datetime.now()
        logger.info(
            "\n\nStarted {} {} at {} on {}".format(
                self.__class__.__name__,
        ...
        uow.job = mockjob
        data = mockjob.run(uow=uow, data=10)
    ...
    # ============================================================================================ #
    def test_badjob(self, container, badjob, caplog):
        start = datetime.now()
        logger.info(
            "\n\nStarted {} {} at {} on {}".format(
                self.__class__.__name__,
