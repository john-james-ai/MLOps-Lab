...
# Version    : 0.1.0                                                                               #
# Python     : 3.10.6                                                                              #
# Filename   : /tests/test_core/test_entity/test_datasource.py                                     #
# ------------------------------------------------------------------------------------------------ #
# Author     : John James                                                                          #
...
class TestDataSource:  # pragma: no cover
    # ============================================================================================ #
    def test_instantiation(self, caplog):
        ...
        assert d.website == "www.spotify.com"
        assert d.url_count == 0  # No children
        # ---------------------------------------------------------------------------------------- #
        end = datetime.now()
    ...
    # ============================================================================================ #
    def test_get_url(self, datasource, caplog):
        start = datetime.now()
        logger.info(
            "\n\n\tStarted {} {} at {} on {}".format(
                self.__class__.__name__,
        ...
        # ---------------------------------------------------------------------------------------- #
        url = datasource.get_url(name="datasource_url_name_1")
    ...
    # ============================================================================================ #
    def test_equality(self, datasource, caplog):
        start = datetime.now()
        logger.info(
            "\n\n\tStarted {} {} at {} on {}".format(
                self.__class__.__name__,
    ...
    # ============================================================================================ #
    def test_dto(self, datasource, caplog):
        start = datetime.now()
        logger.info(
            "\n\n\tStarted {} {} at {} on {}".format(
                self.__class__.__name__,
        ...
        assert dto.name == "datasource_name_1"
        assert dto.description == "Datasource Description 1"
        assert dto.website == "www.spotify.com"

        for i, (name, url) in enumerate(datasource.urls.items(), start=1):
            assert isinstance(url, DataSourceURL)
            dto = url.as_dto()
    ...
    # ============================================================================================ #
    def test_add_url(self, datasource, caplog):
        start = datetime.now()
        logger.info(
            "\n\n\tStarted {} {} at {} on {}".format(
                self.__class__.__name__,
    ...
    # ============================================================================================ #
    def test_remove_url(self, datasource, caplog):
        start = datetime.now()
        logger.info(
            "\n\n\tStarted {} {} at {} on {}".format(
                self.__class__.__name__,
        ...
        datasource.remove_url(name="datasource_url_name_2")
    ...
    # ============================================================================================ #
    def test_magic(self, datasource, caplog):
        start = datetime.now()
        logger.info(
            "\n\n\tStarted {} {} at {} on {}".format(
                self.__class__.__name__,
        ...
        # ---------------------------------------------------------------------------------------- #
        assert datasource.is_composite is True
        assert isinstance(str(datasource), str)
        assert isinstance(repr(datasource), str)
        ...
        for name, url in urls.items():
            ...
            assert len(url) == 1
            assert url.is_composite is False
