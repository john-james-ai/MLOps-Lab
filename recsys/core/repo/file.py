...
# Version    : 0.1.0                                                                               #
# Python     : 3.10.6                                                                              #
# Filename   : /recsys/core/repo/file.py                                                           #
# ------------------------------------------------------------------------------------------------ #
# Author     : John James                                                                          #
...
# Modified   : Wednesday December 28th 2022 03:03:35 pm                                            #
# ------------------------------------------------------------------------------------------------ #
# License    : MIT License                                                                         #
...
class FileRepo(Repo):
    ...
    def add(self, entity: Entity) -> Entity:
        ...
        if entity.dataframe_count > 0:
            for name in entity.dataframe_names:
                ...
                # Note: Persist is false because the Files are persisted with the File
                # object.
    ...
    def print(self) -> None:
        """Prints the repository contents as a File."""
