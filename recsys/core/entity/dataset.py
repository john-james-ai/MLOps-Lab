...
# Modified   : Thursday December 1st 2022 10:32:19 am                                              #
# ------------------------------------------------------------------------------------------------ #
# License    : MIT License                                                                         #
...
from ..dal.dataset import DatasetDTO
...
class Dataset:
    ...
    def __repr__(self) -> str:
        return f"Dataset({self._id}, {self._source}, {self._env}, {self._stage}, {self._name}, {self._description},  {self._version}, {self._cost}, {self._nrows}, {self._ncols}, {self._null_counts}, {self._memory_size_mb}, {self._filepath}, {self._archived}, {self._creator}, {self._created}"
    ...
    def __eq__(self, other) -> bool:
        ...
        if isinstance(other, Dataset):
            return (
                ...
                and self._step_input == other.step_input
                and self._step_output == other.step_output
                ...
                and self._archived == other.archived
    ...
    @property
    def step_input(self) -> bool:
        return self._step_input

    @property
    def step_output(self) -> bool:
