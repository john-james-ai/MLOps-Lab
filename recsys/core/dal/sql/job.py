...
# Modified   : Friday December 9th 2022 09:18:43 am                                                #
# ------------------------------------------------------------------------------------------------ #
# License    : MIT License                                                                         #
...
class InsertJob(SQL):
    ...
    sql: str = """INSERT INTO job (name, description, workspace, start, end, duration, cpu_user_time, cpu_percent, physical_memory_total, physical_memory_available, physical_memory_used, physical_memory_used_pct, RAM_used, RAM_used_pct, disk_usage, disk_usage_pct, disk_read_count, disk_write_count, disk_read_bytes, disk_write_bytes, disk_read_time, disk_write_time, network_bytes_sent, network_bytes_recv, created, modified) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?);"""
    args: tuple = ()
...
class UpdateJob(SQL):
    dto: DTO
    sql: str = """UPDATE job SET name = ?, description = ?, workspace = ?, start = ?, end = ?, duration = ?, cpu_user_time = ?, cpu_percent = ?, physical_memory_total = ?, physical_memory_available = ?, physical_memory_used = ?, physical_memory_used_pct = ?, RAM_used = ?, RAM_used_pct = ?, disk_usage = ?, disk_usage_pct = ?, disk_read_count = ?, disk_write_count = ?, disk_read_bytes = ?, disk_write_bytes = ?, disk_read_time = ?, disk_write_time = ?, network_bytes_sent = ?, network_bytes_recv = ?, created = ?, modified = ?  WHERE id = ?;"""
    args: tuple = ()
