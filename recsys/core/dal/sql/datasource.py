...
# Modified   : Saturday December 10th 2022 07:33:35 pm                                             #
# ------------------------------------------------------------------------------------------------ #
# License    : MIT License                                                                         #
...
class CreateDataSourceTable(SQL):
    name: str = "datasource"
    sql: str = """CREATE TABLE IF NOT EXISTS datasource (id INTEGER PRIMARY KEY, name TEXT NOT NULL, publisher TEXT NOT NULL, description TEXT NOT NULL, website TEXT NOT NULL, created timestamp, modified timestamp);"""
    args: tuple = ()
...
class InsertDataSource(SQL):
    dto: DTO
    sql: str = """INSERT INTO datasource (id, name, publisher, description, website, created, modified) VALUES (?,?,?,?,?,?,?);"""
    args: tuple = ()
...
class UpdateDataSource(SQL):
    dto: DTO
    sql: str = """UPDATE datasource SET name = ?, publisher = ?, description = ?, website = ?, created = ?, modified = ? WHERE id = ?;"""
    args: tuple = ()
